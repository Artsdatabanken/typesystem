...
describe("Natursystem", function() {
  ...
  it("T44-E-1 er ikke grunntype", function() {
    assert.equal(natursystem.erGrunntype("NN-NA-TI-T44-E-1"), false);
  });
  it("T44-1 er grunntype", function() {
    assert.equal(natursystem.erGrunntype("NN-NA-TI-T44-1"), true);
  });
  it("T44-1 erHøyereKartleggingsnivå: nei", function() {
    assert.equal(natursystem.erHøyereKartleggingsnivå("NN-NA-TI-T44-1"), false);
  });
  it("T44-A-1 erHøyereKartleggingsnivå: nei", function() {
    assert.equal(
      natursystem.erHøyereKartleggingsnivå("NN-NA-TI-T44-A-1"),
      false
    );
  });
  it("T44-B-1 erHøyereKartleggingsnivå: ja", function() {
    assert.equal(
      natursystem.erHøyereKartleggingsnivå("NN-NA-TI-T44-B-1"),
      true
    );
  });
});
